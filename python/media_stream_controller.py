...
class MediaStreamController:
    ...
    def start_source_stream(self):
        ...
        vidSrc = self.start_video_source("libcamera-vid --width 640 --height 480 --framerate 16 --codec yuv420 --flush 1 --timeout 0 --nopreview 1 --output - ")
        ...
        ffmpeg_cmd = "ffmpeg -hide_banner -f rawvideo -pix_fmt yuv420p -use_wallclock_as_timestamps 1 -s 640x480 -framerate 16 -i pipe:0 -vcodec libx264 -b:v 700k -g 10 -fflags nobuffer -preset ultrafast -tune zerolatency -f rtp '{rtpUrl}?rtcpport={rtcpPort}&localrtcpport={rtcpPort}&pkt_size=1200'".format(rtpUrl=rtpUrl, rtcpPort=rtcpPort)
