...
class Media_Stream_Controller:
    ...
    async def start_video_source(self, cmd_str=None):
    ...
    async def start_piped_input_command(self, inputPipe=None, cmd_str=None):
        if cmd_str not in self.open_video_stream_map:
    ...
    async def start_source_stream(self, port=1820):
