...
ICM_20948_Status_e ICM_20948_set_full_scale(ICM_20948_Device_t *pdev, ICM_20948_InternalSensorID_bm sensors, ICM_20948_fss_t fss)
{
  ...
  if (sensors & ICM_20948_Internal_Acc)
  {
    ...
    retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_set_bank(pdev, 2)); // Must be in the right bank
    retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_execute_r(pdev, AGB2_REG_ACCEL_CONFIG, (uint8_t *)&reg, sizeof(ICM_20948_ACCEL_CONFIG_t)));
    reg.ACCEL_FS_SEL = fss.a;
    retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_execute_w(pdev, AGB2_REG_ACCEL_CONFIG, (uint8_t *)&reg, sizeof(ICM_20948_ACCEL_CONFIG_t)));
    // Check the data was written correctly
    retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_execute_r(pdev, AGB2_REG_ACCEL_CONFIG, (uint8_t *)&reg, sizeof(ICM_20948_ACCEL_CONFIG_t)));
    if (reg.ACCEL_FS_SEL != fss.a)
      retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_Stat_Err);
  }
  if (sensors & ICM_20948_Internal_Gyr)
  {
    ICM_20948_GYRO_CONFIG_1_t reg;
    retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_set_bank(pdev, 2)); // Must be in the right bank
    retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_execute_r(pdev, AGB2_REG_GYRO_CONFIG_1, (uint8_t *)&reg, sizeof(ICM_20948_GYRO_CONFIG_1_t)));
    reg.GYRO_FS_SEL = fss.g;
    retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_execute_w(pdev, AGB2_REG_GYRO_CONFIG_1, (uint8_t *)&reg, sizeof(ICM_20948_GYRO_CONFIG_1_t)));
    // Check the data was written correctly
    retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_execute_r(pdev, AGB2_REG_GYRO_CONFIG_1, (uint8_t *)&reg, sizeof(ICM_20948_GYRO_CONFIG_1_t)));
...
ICM_20948_Status_e ICM_20948_set_sample_rate(ICM_20948_Device_t *pdev, ICM_20948_InternalSensorID_bm sensors, ICM_20948_smplrt_t smplrt)
{
  ...
  if (sensors & ICM_20948_Internal_Acc)
  {
    ...
    retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_execute_w(pdev, AGB2_REG_ACCEL_SMPLRT_DIV_1, &div1, 1));
    retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_execute_w(pdev, AGB2_REG_ACCEL_SMPLRT_DIV_2, &div2, 1));
  }
  if (sensors & ICM_20948_Internal_Gyr)
  {
    retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_set_bank(pdev, 2)); // Must be in the right bank
    uint8_t div = (smplrt.g);
    retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_execute_w(pdev, AGB2_REG_GYRO_SMPLRT_DIV, &div, 1));
  }
  return retval;
}
...
ICM_20948_Status_e ICM_20948_get_agmt(ICM_20948_Device_t *pdev, ICM_20948_AGMT_t *pagmt)
{
  ...
  // Get readings
  retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_set_bank(pdev, 0));
  retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_execute_r(pdev, (uint8_t)AGB0_REG_ACCEL_XOUT_H, buff, numbytes));
  ...
  retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_set_bank(pdev, 2));
  ICM_20948_ACCEL_CONFIG_t acfg;
  retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_execute_r(pdev, (uint8_t)AGB2_REG_ACCEL_CONFIG, (uint8_t *)&acfg, 1 * sizeof(acfg)));
  ...
  retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_execute_r(pdev, (uint8_t)AGB2_REG_GYRO_CONFIG_1, (uint8_t *)&gcfg1, 1 * sizeof(gcfg1)));
  pagmt->fss.g = gcfg1.GYRO_FS_SEL;
  ICM_20948_ACCEL_CONFIG_2_t acfg2;
  retval = static_cast<ICM_20948_Status_e>(retval | ICM_20948_execute_r(pdev, (uint8_t)AGB2_REG_ACCEL_CONFIG_2, (uint8_t *)&acfg2, 1 * sizeof(acfg2)));
