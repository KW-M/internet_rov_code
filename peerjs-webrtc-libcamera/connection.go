...
func pipeVideoToStream(done chan bool) error {
	...
	cmd := exec.Command("libcamera-vid", "--width", "640", "--height", "480", "--framerate", "16", "--bitrate", "8000000", "--codec", "h264", "--profile", "high", "--level", "4", "--inline", "1", "--flush", "1", "--timeout", "0","--nopreview", "1", "--output", "-") //"--listen", "1", "--output", "tcp://0.0.0.0:8585")
