...
# From: https://www.linux-projects.org/uv4l/installation/
echo -e "$Cyan Installing packages with apt: nginx uv4l uv4l-raspicam  uv4l-server uv4l-demos uv4l-raspidisp uv4l-raspidisp-extras uv4l-raspicam-extras $Color_Off"
sudo apt install -y nginx uv4l-raspicam uv4l-server uv4l-demos uv4l-raspicam-extras uv4l-raspidisp uv4l-raspidisp-extras
